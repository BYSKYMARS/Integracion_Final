...
{
    /// <inheritdoc />
    public partial class ValidacionesCorregidas2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DireccionDestino = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Envios_Usuarios_RepartidorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialesEnvio", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialesEnvio_Envios_EnvioId",
                        column: x => x.EnvioId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialesEnvio_EnvioId",
